...
var marcasDeCarros = ['fiat', 'bmw', 'renault', 'volks'];
var marcasDeMotos = ['honda', 'yamaha', 'royal-enfield', 'suzuki'];
var marcasVeiculos = [].concat(marcasDeCarros, marcasDeMotos);
...
var _marcasVeiculos = _toArray(marcasVeiculos),
  item1 = _marcasVeiculos[0],
  item2 = _marcasVeiculos[1],
  item3 = _marcasVeiculos[2],
  outrasMarcas = _marcasVeiculos.slice(3);
console.log(item1);
console.log(item2);
console.log(item3);
